...
if version >= 700 " Vim 7.x specific colors
  ...
  call <SID>X("MatchParen","ffffff","904030","italic,underline")
  call <SID>X("Search","f0f000","000000","italic,underline")
endif
...
call <SID>X("StatusLine","f8e0d0","080404","none")
...
"call <SID>X("Comment","686460","080404","italic")
...
call <SID>X("Constant","60d060","080404","italic")
...
hi Error guifg=#cc0000 guibg=NONE guisp=#854d50 gui=NONE ctermfg=196 ctermbg=NONE cterm=NONE
" call <SID>X("Error","e2e4e5","","none")
hi ErrorMsg guifg=#cc0000 guibg=NONE guisp=NONE gui=NONE ctermfg=196 ctermbg=NONE cterm=NONE
" call <SID>X("ErrorMsg","b4b0b0","","none")
call <SID>X("WarningMsg","e2e4e5","","none")
"rubyFunction
call <SID>X("Function","cc9900","080404","italic")
"rubyIdentifier
"@var, @@var, $var, etc
...
call <SID>X("Structure","2eb82e","080404","italic")
...
"c code
call <SID>X("cConstant","60d060","080404","italic")
call <SID>X("cFunctions","cc9900","080404","italic")
call <SID>X("cType","a1a83e","080404","italic")
call <SID>X("cStructure","2eb82e","080404","italic")
call <SID>X("cKeyword","705850","080404","italic")
call <SID>X("cStatement","506090","080404","italic,underline")
call <SID>X("cDefine","a090a0","080404","italic")
call <SID>X("Label","ffff00","080404","italic")
call <SID>X("Type","a1a83e","080404","italic")
call <SID>X("Macro","607080","080404","italic")
call <SID>X("DefinedName","a090a0","080404","italic")
call <SID>X("cSpecial","a06050","181414","italic")
call <SID>X("cOperator","705850","080404","italic")
call <SID>X("cInclude","a090a0","080404","italic")
call <SID>X("cPreCondit","a090a0","080404","italic")
call <SID>X("cString","a06050","080404","italic")
hi cPreProc guifg=#a090a0 guibg=#5e2b2b guisp=#5e2b2b gui=italic ctermfg=247 ctermbg=52 cterm=NONE
hi cComment guifg=#9e856b guibg=NONE guisp=#080404 gui=italic ctermfg=137 ctermbg=232 cterm=NONE
hi cTodo guifg=#686460 guibg=NONE guisp=#080404 gui=italic ctermfg=242 ctermbg=232 cterm=NONE
call <SID>X("cStorageClass","2eb82e","080404","italic")
call <SID>X("EnumerationValue","a090a0","080404","italic")
call <SID>X("EnumeratorName","2eb82e","080404","italic")
call <SID>X("cFloat","60d060","080404","none")
call <SID>X("cRepeat","906050","080404","underline")
call <SID>X("cLabel","705850","080404","italic")
call <SID>X("cConditional","609050","080404","underline")
call <SID>X("cSpecialCharacter","a06050","181414","italic")
call <SID>X("GlobalVariable","a06050","181414","italic")
call <SID>X("Extern","a06050","181414","italic")
hi cRepeat gui=italic,underline  cterm=italic,underline
hi cConditional gui=italic,underline  cterm=italic,underline
hi cLabel gui=italic  cterm=italic
hi cSpecialCharacter gui=italic  cterm=italic
hi GlobalVariable gui=italic  cterm=italic
hi Extern gui=italic  cterm=italic
hi cFunctions gui=italic  cterm=italic
hi Function gui=italic  cterm=italic
hi cType gui=italic cterm=italic
hi Keyword gui=italic cterm=italic
hi cConstant gui=italic cterm=italic
hi cStatement gui=italic,underline cterm=italic,underline
hi cDefine gui=italic cterm=italic
hi Label gui=italic cterm=italic
hi Type gui=italic cterm=italic
hi DefinedName gui=italic cterm=italic
hi cSpecial gui=italic cterm=italic
hi cOperator gui=italic cterm=italic
hi cInclude gui=italic cterm=italic
hi cPreCondit gui=italic cterm=italic
hi cString gui=italic cterm=italic
hi cConstant gui=italic cterm=italic
hi cStructure gui=italic cterm=italic
hi Structure gui=italic cterm=italic
hi Class gui=italic cterm=italic
hi cComment gui=italic cterm=italic
hi cStorageClass gui=italic cterm=italic
hi EnumerationValue gui=italic cterm=italic
hi EnumeratorName gui=italic cterm=italic
call <SID>X("cMathOperator","944dff","080404","none")
call <SID>X("cLogicalOperator","944dff","080404","none")
call <SID>X("cPointerOperator","944dff","080404","none")
call <SID>X("cMatchMatch","a090a0","080404","italic")
...
hi CTagsGlobalVariable guifg=#6c9fb8 guibg=NONE guisp=NONE gui=NONE ctermfg=67 ctermbg=NONE cterm=NONE
...
call <SID>X("SpellRare","cc0000","000000","underline")
call <SID>X("SpellCap","cc0000","000000","underline")
call <SID>X("SpellLocal","cc0000","000000","underline")
call <SID>X("SpellBad","cc0000","000000","underline")

call <SID>X("MoreMsg","e2e4e5","","none")

call <SID>X("WildMenu","e2e4e5","","none")
hi SignColumn ctermfg=180 ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE gui=NONE
"call <SID>X("SignColumn","000000","","none")
