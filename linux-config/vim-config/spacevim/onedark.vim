...
call s:h("Function", { "fg": s:yellow, "gui": "italic", "cterm": "italic", "term": "italic"}) " function name (also: methods for classes)
"call s:h("CTagsFunction", { "fg": s:blue, "gui": "italic", "cterm": "italic", "term": "italic"}) " functilicon name (also: methods for classes)
call s:h("cFunctions", { "fg": s:blue, "gui": "italic", "cterm": "italic"}) " function name (also: methods for classes)
call s:h("Statement", { "fg": s:purple }) " any statement
call s:h("Conditional", { "fg": s:purple }) " if, then, else, endif, switch, etc.
call s:h("Repeat", { "fg": s:purple }) " for, do, while, etc.
call s:h("Label", { "fg": s:purple }) " case, default, etc.
call s:h("Operator", { "fg": s:purple }) " sizeof", "+", "*", etc.
call s:h("Keyword", { "fg": s:dark_red }) " any other keyword
...
call s:h("StorageClass", { "fg": s:green }) " static, register, volatile, etc.
call s:h("Structure", { "fg": s:green }) " struct, union, enum, etc.
call s:h("Typedef", { "fg": s:green }) " A typedef
...
call s:h("CTagsEnumerationValue", { "fg": s:red })
call s:h("CTagsDefinedName", { "fg": s:red })
call s:h("CTagsGlobalVariable", { "fg": s:blue })
