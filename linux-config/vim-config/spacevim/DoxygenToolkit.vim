...
if !exists("g:DoxygenToolkit_briefTag_funcName_pre")
  let g:DoxygenToolkit_briefTag_funcName_pre = "@function "
endif
...
function! <SID>DoxygenCommentFunc()
  ...
  elseif( s:CheckFileType() == "cpp" || s:CheckFileType() == "c")
  ...
  if( l:doc.name != "None" )
    ...
    exec "normal o".s:interCommentTag.g:DoxygenToolkit_briefTag_funcName_pre.l:doc.name." "
  endif
